...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full px-8 lg:px-16 flex-row items-center justify-between self-start rounded-full bg-transparent py-2 lg:flex dark:bg-transparent",
        visible && "bg-white/80 dark:bg-neutral-950/80 px-4 lg:px-4",
        className
      )}
    >
      {children}
  ...
  return (
    <motion.div
      animate={{
        ...
        borderRadius: visible ? "4rem" : "2rem",
        // y: visible ? 20 : 0,
      }}
      transition={{
        type: "spring",
